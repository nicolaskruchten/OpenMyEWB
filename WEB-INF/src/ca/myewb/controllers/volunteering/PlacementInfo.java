...
public class PlacementInfo extends Controller
{
	public void handle(Context ctx) throws Exception
	{
		PlacementModel p = (PlacementModel)getAndCheckFromUrl(PlacementModel.class);
		ctx.put("placement", p);
		
		Vector<Toolbar> toolbars = new Vector<Toolbar>();
		toolbars.add(new ca.myewb.frame.toolbars.PlacementInfo());
