...
public class ApplicationQuestionList extends Controller
{
	public void handle(Context ctx) throws Exception
	{
		ApplicationSessionModel s = (ApplicationSessionModel)getAndCheckFromUrl(ApplicationSessionModel.class);
		ctx.put("session", s);
		ctx.put("questions", s.getQuestions());
		
		Vector<Toolbar> toolbars = new Vector<Toolbar>();
		toolbars.add(new ca.myewb.frame.toolbars.ApplicationQuestionList());
	...
	{
		return "Application Question List";
	}
