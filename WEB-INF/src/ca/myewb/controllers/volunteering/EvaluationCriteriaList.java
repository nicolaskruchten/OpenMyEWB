...
public class EvaluationCriteriaList extends Controller
{
	public void handle(Context ctx) throws Exception
	{
		...
		toolbars.add(new ca.myewb.frame.toolbars.EvaluationCriteriaList());
	...
	{
		return "Evaluation Criteria for Session";
	}
