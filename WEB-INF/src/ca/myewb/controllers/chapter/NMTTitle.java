...
public class NMTTitle extends Controller
{
	public void handle(Context ctx) throws Exception
	{
		...
		{
			throw getSecurityException("That person is not an NMT (could be just an admin)!",
		...
		{
			// Create a new form
			f = new ExecTitleForm(path + "/actions/SaveNMTTitle", requestParams, false, false);
			f.setValue("Title", targetUser.getNMTTitle());
