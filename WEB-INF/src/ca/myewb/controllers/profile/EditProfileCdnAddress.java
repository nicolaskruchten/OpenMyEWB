...
public class EditProfileCdnAddress extends Controller
{
	public void handle(Context ctx) throws Exception
	{
		...
		UserProfileCdnAddressForm f = (UserProfileCdnAddressForm)checkForValidationFailure(ctx);
		...
		if (f == null)
		{
			...
			{
				isRegular = true;
				f = new UserProfileCdnAddressForm(path
