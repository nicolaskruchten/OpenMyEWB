...
public class Impersonate extends Controller
{
	public void handle(Context ctx) throws Exception
	{
		...
		// Successful login!
		httpSession.setAttribute("userid", new Integer(targetUser.getId()));
		log.warn("Admin " + currentUser.getUsername() + " is impersonating "
		         + targetUser.getUsername());
		log.debug("Setting user to " + targetUser.getUsername());
